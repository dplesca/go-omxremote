...
<div class="container mx-auto my-5">
  <YouTube></YouTube>
  <div class="p-2">
    <input bind:value={q} type="text" placeholder="search" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" on:keyup={search}>
  </div>
